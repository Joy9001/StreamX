    ...
    <div className="flex">
        ...
        <div className='container mx-auto max-w-5xl px-4 py-8'>
          ...
          <div className='flex gap-4'>
            <button
              ...
              className='rounded-md bg-green-600 px-4 py-2 text-white transition duration-300 hover:bg-green-700'>
              Add Money
            </button>
            <button
              onClick={toggleWithdrawForm}
              className='rounded-md bg-indigo-600 px-4 py-2 text-white transition duration-300 hover:bg-indigo-700'
      ...
      {showWithdrawForm && (
        <div className='mb-8 rounded-lg bg-white p-6 shadow-md'>
          ...
          {withdrawSuccess ? (
            <div className='rounded-md bg-green-100 p-4 text-green-800'>
              Successfully requested withdrawal of ${withdrawAmount}. It will be
