...
const VideoDrawer = () => {
  ...
  return drawerContent ? (
    <div className='flex h-full flex-col overflow-hidden rounded-lg bg-neutral-50'>
      <header className='flex flex-shrink-0 items-center justify-between border-b border-neutral-200 p-4'>
