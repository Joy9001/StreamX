        ...
        <form onSubmit={handleSubmit}>
          <div className="py-4">
            ...
            <input
              ...
              onChange={(e) => setFormData({ ...formData, YTchannelname: e.target.value })}
              className="input input-bordered mb-4 w-full"
            />
            ...
            <input
              ...
              onChange={(e) => setFormData({ ...formData, ytChannelLink: e.target.value })}
              className="input input-bordered mb-4 w-full"
            />
            ...
            <input
              ...
              onChange={(e) => setFormData({ ...formData, storageLimit: Number(e.target.value) * 1024 })}
              className="input input-bordered mb-4 w-full"
              min="1"
              required
            />
