...
function ApproveTable() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                console.log(`Fetching ${isEditor ? 'editor' : ''} requests to approve with ID:`, userId)
    ...
    const handleApprove = async (requestId, videoId, toId = null) => {
        try {
            const accessToken = await getAccessTokenSilently()
            ...
            console.log(`${isEditor ? 'Editor' : ''} approving request:`, { requestId, videoId, toId, userId })
            ...
            dispatch(approveRequest(approveData))
        } catch (error) {
    ...
    const headerGradient = isEditor ? 'from-purple-50 to-indigo-50' : 'from-blue-50 to-indigo-50'
                                    ...
                                    <tr
                                        ...
                                        <td className='whitespace-nowrap px-6 py-4'>
                                            <div className='flex items-center'>
                                                ...
                                                <div className='ml-3'>
                                                    <div className='text-sm font-medium text-gray-900'>
                                                        {counterparty?.name || (isEditor ? 'Unknown Owner' : 'Unknown Editor')}
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
