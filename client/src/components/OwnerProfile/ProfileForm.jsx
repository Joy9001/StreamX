...
export default function ProfileForm() {
  ...
  const validateField = (name, value) => {
    ...
    if (name === 'username' && !validations.username.test(value)) {
      error = 'Username must be 3-30 characters and can only contain letters, numbers, spaces, and underscores.'
    }
  ...
  return (
    <div className="p-4">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold bg-gradient-to-r from-pink-300 to-pink-500 bg-clip-text text-transparent">
          Edit Profile
        </h2>
