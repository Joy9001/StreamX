...
const { getAllOwners, getAllEditors, getAllRequests, getAllVideos } = await import(
...
describe('Admin Controller', () => {
	...
	describe('getAllRequests', () => {
		...
		const mockEditors = [{ _id: 'editor1', name: 'Editor 1' }]

		const mockAdmins = [{ _id: 'admin1', username: 'Admin 1' }]
